...
assert.equal(manifest.schools.length,8,'the protected rollout must contain exactly eight certified schools');
...
console.log(`Protected-school guard passed for ${manifest.schools.length}/8 certified schools.`);
